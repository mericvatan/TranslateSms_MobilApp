...
import com.example.project.ui.theme.Aqua
    ...
    Box(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = stringResource(R.string.talk_with_your_friends),
                    style = TextStyle(
                        fontSize = 36.sp,
                        color = Color.White,
...
fun CustomCheckBox() {
    ...
    Row(
        ...
        SpacerWidth(15.dp)
        Text(
            text = stringResource(R.string.secure_message), style = TextStyle(
                color = Color.White,
                fontSize = 16.sp,
                fontWeight = FontWeight.Bold
            )
